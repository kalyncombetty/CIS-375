...
{ 
    ...
    class cForceDrag : cForce
    {
        ...
        public override cVector3 force(cCritter pcritter)
        {
            ...
            return _windvector - pcritter.Velocity * area * _intensity;
        }
    }		
	...
	{ 
		...
		public override cVector3 force( cCritter pcritter ) 
		{
			return _pulldirection * _intensity * pcritter.Mass; 
		} 
	...
	class cForceClassEvade<DataType> : cForceClass 
	{ 
        ...
        public override cForce copy( )
        {
            cForceClassEvade<DataType> f = new cForceClassEvade<DataType>();
            f.copy(this);
            return f;
        }
	...
	class cForceEvadeBullet : cForceClassEvade<cCritterBullet>
	{ 
