...
{ 
		...
		{ 
			...
			case 0 : 
				_childspriteptr[ 0 ].SpriteAttitude =  
					cMatrix3.translation( new cVector3( Lox, Midy, Midz)) * 
						( cMatrix3.xRotation((float) -Math.PI / 2.0f ) *
						( cMatrix3.yRotation( (float) Math.PI / 2.0f ) *
						cMatrix3.zRotation( (float) Math.PI ))); 
				break; 
			case 1 : 
				_childspriteptr[ 1 ].SpriteAttitude = 
					cMatrix3.translation( new cVector3( Hix, Midy, Midz)) * 
						( cMatrix3.xRotation( (float) Math.PI / 2.0f ) * 
						cMatrix3.yRotation( (float) Math.PI / 2.0f )); 
				break; 
			case 2 : 
				_childspriteptr[ 2 ].SpriteAttitude = 
					cMatrix3.translation( new cVector3( Midx, Loy, Midz)) * 
			...
			case 3 : 
				_childspriteptr[ 3 ].SpriteAttitude = 
					cMatrix3.translation( new cVector3( Midx, Hiy, Midz)) * 
						( cMatrix3.zRotation( 3 * (float) Math.PI / 2.0f ) * 
						( cMatrix3.yRotation( (float) Math.PI / 2.0f ) * 
						cMatrix3.zRotation( (float) Math.PI / 2.0f ))); 
				break; 
			case 4 : 
				_childspriteptr[ 4 ].SpriteAttitude = 
					cMatrix3.translation( new cVector3( Midx, Midy, Loz)) * 
	...
	//Mutator 
		...
		{ 
			base.copy( psprite ); 
			if ( !( psprite is cSpriteTextureBox )) 
