...
namespace ACFramework
{
    ...
    class cSpriteBubble : cSpriteComposite //Basic bubble has a circular polygon and a rect on top.
    {
        ...
        {
            cShape pcircle = new cShape(cSpriteCircle.CIRCLESLICES);
            add(pcircle);
            setAccentPoly();
        }
        ...
        public virtual void setAccentPoly()
        {
            ...
            cShape prectpoly = new cShape(4, pverts);
        ...
        public virtual cShape CirclePoly
        {
            get
            {
        ...
        public virtual cShape AccentPoly
        {
            get
            {
                if (_childspriteptr.Size > 1)
                    return (cShape)(_childspriteptr[1]);
                else
                    return null;
            }
        }
