...
namespace ACFramework
{
    ...
    class cSprite
    {
        ...
        protected float _prismdz; /* _prismdz is a kludge variable that I put in so that flat sprites will
			...
			default is 0.0.  If nonzero _prsimz, it turns a	2D sprite like a cShape or a 
        ...
        protected bool topPoint = false;  // for prisms and cones
        ...
        /* The default cSprite method for setRadius 
            does the miniumum, to reset _radius.   cShape and cIcon override setRadius, by
        ...
        public virtual void rotate(float angle) { _spriteattitude *= cMatrix3.zRotation(angle); }

        public virtual void rotate(cSpin spin) { _spriteattitude *= cMatrix3.rotation(spin); }
        //3D Mutators 
    ...
    class cSpriteComposite : cSprite
    {
        ...
        public override void copy(cSprite psprite)
        {
            ...
            if (!( psprite is cSpriteComposite))
        ...
        public override float Radius
        {
            ...
            set
            {
                ...
                _spriteattitude *= cMatrix3.scale(scalefactor);
